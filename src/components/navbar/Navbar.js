            ...
            <nav id='nav' className={scroll ? 'bg-white' : 'bg-trans'}>
                ...
                <div className='upside'>
                    ...
                    <div className="info">
                        ...
                        <ul className="dropdown-menu d-menu-custom" aria-labelledby="dropdownMenuLink">
                            <li><a className="dropdown-item dropdown-text" href="/"><strong>Sign up</strong></a></li>
                            <li><a className="dropdown-item dropdown-text" href="/">Login</a></li>
                            <li><hr className="dropdown-divider" /></li>
                            <li><a className="dropdown-item dropdown-text" href="/">Host your home</a></li>
                            <li><a className="dropdown-item dropdown-text" href="/">Host an experience</a></li>
                            <li><a className="dropdown-item dropdown-text" href="/">Help</a></li>
                        </ul>
                    </div>
                </div>
